...
@interface Alonso_Gustavo_Project3Object : KrollCoverageObject {
#else
@interface Alonso_Gustavo_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Alonso_Gustavo_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Alonso_Gustavo_Project3Object *_alonso_gustavo_project3;
    KrollObject* console;
	BOOL shutdown;
