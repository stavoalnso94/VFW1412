...
/**
 The base class for all Alonso_Gustavo_Project3 modules
 */
...
/**
 Alonso_Gustavo_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Alonso_Gustavo_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Alonso_Gustavo_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Alonso_Gustavo_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Alonso_Gustavo_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
