...
// in simulator we redefine to format for Alonso_Gustavo_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.alonso_gustavo_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alonso_gustavo_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAlonso_Gustavo_Project3NativeItemNone = -1, 
	UIAlonso_Gustavo_Project3NativeItemSpinner = -2,
	UIAlonso_Gustavo_Project3NativeItemProgressBar = -3,
	
	UIAlonso_Gustavo_Project3NativeItemSlider = -4,
	UIAlonso_Gustavo_Project3NativeItemSwitch = -5,
	UIAlonso_Gustavo_Project3NativeItemMultiButton = -6,
	UIAlonso_Gustavo_Project3NativeItemSegmented = -7,
	
	UIAlonso_Gustavo_Project3NativeItemTextView = -8,
	UIAlonso_Gustavo_Project3NativeItemTextField = -9,
	UIAlonso_Gustavo_Project3NativeItemSearchBar = -10,
	
	UIAlonso_Gustavo_Project3NativeItemPicker = -11,
	UIAlonso_Gustavo_Project3NativeItemDatePicker = -12,
	
	UIAlonso_Gustavo_Project3NativeItemInfoLight = -13,
	UIAlonso_Gustavo_Project3NativeItemInfoDark = -14,
	
	UIAlonso_Gustavo_Project3NativeItemDisclosure = -15,
	
	UIAlonso_Gustavo_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Alonso_Gustavo_Project3 instances of
