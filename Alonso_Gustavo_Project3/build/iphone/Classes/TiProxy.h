...
//Rare exceptions to indicate a bug in the _alonso_gustavo_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Alonso_Gustavo_Project3 proxies.
 */
