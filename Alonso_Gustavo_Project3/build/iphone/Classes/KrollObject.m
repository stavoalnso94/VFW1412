...
//@interface Alonso_Gustavo_Project3Object : NSObject
//@end

@interface Alonso_Gustavo_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Alonso_Gustavo_Project3Object class]])
		{
			for (NSString *key in [[(Alonso_Gustavo_Project3Object*)o modules] allKeys])
			{
