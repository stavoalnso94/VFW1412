...
/**
 Base class for all Alonso_Gustavo_Project3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Alonso_Gustavo_Project3 view hierarchy (such as wrapped iOS UIViews) was touched.
