 ...
 * to send analytic data that can be viewed on the Alonso_Gustavo_Project3 Dashboard.
 *
 * For information on getting started with Alonso_Gustavo_Project3 Platform Services,
